const projectsDatas = [
  ...
  },
  {
    ...
    projectName: "excel creator for a specefic problem",
    description:
...
// ------------------------------- project left dashboard ----------------------
let contentContainer = document.getElementById("choseProjectHandle");
// let content;
for (let i = 0; i < projectsDatas.length; i++) {
  let el = `<div id="project${i}" class="project-container project${i}" onclick="javascript:myFunc(${i})")>
  
  <div class="col-md-8">
 <p class="project-link">${i + 1 + ". " + projectsDatas[i].projectName}</p>
  </div>
  <div class="col-md-4">
  <img
  class="little-img"
  ...
  contentContainer.innerHTML = contentContainer.innerHTML + el;
}

function myFunc(a) {
  console.log(`the id is : ${a}`);

  // --------------------------------the project-----------------------------------
  theProjectContainer = document.getElementById("theProject");
  let el = `<div id="theProject"><h1 id="projectTitle">${projectsDatas[a].projectName}</h1>
  <div class="row">
    <div class="col-md-6">
      <img
        class=""
        src=${projectsDatas[a].imgUrl}
        alt=""
      />
    </div>
    <div class="col-md-6">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div id="technologies">
        <p>${projectsDatas[a].usedTechnologies}</p>
      </div>
    </div>
    <div class="col-md-6">
      <h3 class="subtitle">Url:</h3>
      <a href="${projectsDatas[a].websiteUrl}">${projectsDatas[a].websiteUrl}</a>
    </div>
  </div>
  <div class="col-md-12">
    <h3 class="subtitle">What i have learned</h3>
    <p>
      ${projectsDatas[a].whatILearned}
    </p>
  </div>
  <div class="col-md-12">
  ...
  theProjectContainer.innerHTML = el;

  for (let i = 0; i < projectsDatas.length; i++) {
    // all background orange
    let container = document.querySelector(`.project${i}`);
    container.style.background = "var(--mainOrange)";
    // choosed background blue
    let active = document.querySelector(`.project${a}`);
    active.style.background = "var(--mainLightBlue)";
  }
  // mobilmenu
