...
describe('Slides', () => {
    test('can create a Slide component.', () => {
        const splide = (0, test_1.init)({}, { length: 0 });
    ...
    test('can provide all Slide components with/without clones.', () => {
        ...
        const { Slides } = splide.Components;
        const slides = document.getElementsByClassName(classes_1.CLASS_SLIDE);
        const clones = document.getElementsByClassName(classes_1.CLASS_CLONE);
    ...
    test('can provide Slide components in the specified page.', () => {
        const splide = (0, test_1.init)({ perPage: 3 }); // end index: 7
        const { Slides } = splide.Components;
    ...
    test('can tell if there are enough slides to move or not.', () => {
        const splide = (0, test_1.init)({ perPage: 3 }, { length: 2 });
        const { Slides } = splide.Components;
