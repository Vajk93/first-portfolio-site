...
describe('merge', () => {
    test('can merge 2 objects.', () => {
        ...
        expect((0, merge_1.merge)(object, source)).toStrictEqual({ a: 2, b: '2', c: true });
    ...
    test('can merge 2 objects recursively.', () => {
        ...
        expect((0, merge_1.merge)(object, source)).toStrictEqual({
            a: 1,
            b: { c: 2, d: 4, e: 5 },
            f: true,
        });
    ...
    test('can merge multiple objects recursively.', () => {
        ...
        const source4 = { a: '1' };
        const merged = (0, merge_1.merge)(object, source1, source2, source3, source4);
    ...
    test('should disconnect reference of arrays.', () => {
        ...
        const object = {};
        const source = { array };
        const merged = (0, merge_1.merge)(object, source);
